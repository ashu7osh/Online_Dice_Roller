...
(function(dice) {
    ...
    this.standart_dice_face_labels = [' ', '0', '1', '2', '3', '4', '5', '6', '7', '8'];
    ...
    this.known_types = ['d4', 'd6', 'd8'];
    this.dice_face_range = { 'd4': [1, 4], 'd6': [1, 6], 'd8': [1, 8] };
    this.dice_mass = { 'd4': 300, 'd6': 300, 'd8': 340 };
    this.dice_inertia = { 'd4': 5, 'd6': 13, 'd8': 10 };
    ...
    this.create_d6 = function() {
        ...
        if (!this.dice_material) this.dice_material = new THREE.MeshFaceMaterial(
                this.create_dice_materials(this.standart_dice_face_labels, this.scale / 2, 1.0));
    ...
    this.create_d8 = function() {
        ...
        if (!this.dice_material) this.dice_material = new THREE.MeshFaceMaterial(
                this.create_dice_materials(this.standart_dice_face_labels, this.scale / 2, 1.2));
    ...
    this.dice_box.prototype.draw_selector = function() {
        ...
        var startPos = -(that.known_types.length - 1) / 2;
        for (var i = 0, pos = startPos; i < that.known_types.length; ++i, ++pos) {
